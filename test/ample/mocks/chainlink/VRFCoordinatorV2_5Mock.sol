...
} from "chainlink-brownie-contracts/v0.8/dev/interfaces/IVRFCoordinatorV2Plus.sol";
import {VRFV2PlusClient} from "chainlink-brownie-contracts/v0.8/dev/vrf/libraries/VRFV2PlusClient.sol";
import {SubscriptionAPI} from "chainlink-brownie-contracts/v0.8/dev/vrf/SubscriptionAPI.sol";
...
contract VRFCoordinatorV2_5Mock is SubscriptionAPI, IVRFCoordinatorV2Plus {
    ...
    function consumerIsAdded(uint256 _subId, address _consumer) public view returns (bool) {
        return s_consumers[_consumer][_subId] != 0;
    }
    ...
    function _chargePayment(uint96 payment, bool nativePayment, uint256 subId) internal {
        ...
        if (nativePayment) {
            ...
            s_withdrawableNative[address(this)] += payment;
        } else {
            ...
            s_withdrawableTokens[address(this)] += payment;
        }
    }
        ...
        nonReentrant
    {
        ...
        s_consumers[_consumer][_subId] = 0;
    ...
    function cancelSubscription(uint256 _subId, address _to) external override onlySubOwner(_subId) nonReentrant {
        (uint96 balance, uint96 nativeBalance) = deleteSubscription(_subId);
